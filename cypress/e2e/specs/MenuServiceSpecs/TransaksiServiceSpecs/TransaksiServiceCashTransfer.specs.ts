...
import { DeskripsiNominal, berat, deskripsiPesanan, jenisBayarTransfer, kodeSales, namaBarang, namaCustomer, noHp, noRekening, ongkos, password, username } from '../../../../constant';
