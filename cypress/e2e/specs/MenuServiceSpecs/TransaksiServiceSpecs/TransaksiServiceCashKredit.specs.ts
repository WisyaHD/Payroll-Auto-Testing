...
import { DeskripsiNominal, berat, deskripsiPesanan, jenisBayarKredit, kodeSales, namaBarang, namaCustomer, noHp, noRekening, ongkos, password, username } from '../../../../constant';
