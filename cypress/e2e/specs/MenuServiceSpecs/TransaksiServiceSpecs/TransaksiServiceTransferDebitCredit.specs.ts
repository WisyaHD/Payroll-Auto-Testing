...
import { DeskripsiNominal, berat, card, deskripsiPesanan, jenisBayarDebit, jenisBayarKredit, jenisBayarTransfer, kodeSales, namaBarang, namaCustomer, noHp, noRekening, ongkos, password, username } from '../../../../constant';
...
describe('AccessMenuTransaksiService', () => {
    ...
    it('click menu', () => {
        ...
        cy.wait(1000);
        page.servicePage.transaksiServicePage.modalSimpananService.PilihJenisBayarSelectComboBox().type(`${jenisBayarTransfer}{downArrow}{enter}`,{force: true});
        ...
        page.servicePage.transaksiServicePage.modalSimpananService.CardNoInputBox().type(`${card}`, {force: true});
        ...
        cy.wait(1000);
        page.servicePage.transaksiServicePage.modalSimpananService.PilihJenisBayarSelectComboBox().type(`${jenisBayarKredit}{downArrow}{enter}`,{force: true});
        page.servicePage.transaksiServicePage.modalSimpananService.NoRekeningSelectComboBox().type(`${noRekening}{downArrow}{enter}`,{force: true});
        page.servicePage.transaksiServicePage.modalSimpananService.CardNoInputBox().type(`${card}`, {force: true});
