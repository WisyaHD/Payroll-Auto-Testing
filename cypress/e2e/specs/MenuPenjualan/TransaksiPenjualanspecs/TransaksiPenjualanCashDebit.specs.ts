...
describe('AccessMenuTransaksiPenjualan', () => {
    ...
    it('click menu', () => {
        ...
        cy.wait(1000);
        page.penjualanPage.transaksiPenjualanPage.modalDataBarang.KodeBarcodeInputBox().type('00000932');
        cy.wait(5000);
        ...
        cy.wait(1000);
        page.penjualanPage.transaksiPenjualanPage.modalSimpananPenjualan.PilihJenisBayarSelectComboBox().type('DEBET{downArrow}{enter}',{force: true});
