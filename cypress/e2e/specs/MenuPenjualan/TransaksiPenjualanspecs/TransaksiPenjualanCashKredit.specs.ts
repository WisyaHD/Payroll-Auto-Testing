...
describe('AccessMenuTransaksiPenjualan', () => {
    ...
    it('click menu', () => {
        ...
        cy.wait(1000);
        page.penjualanPage.transaksiPenjualanPage.modalDataBarang.KodeBarcodeInputBox().type('00000931');
        cy.wait(5000);
        ...
        cy.wait(1000);
        page.penjualanPage.transaksiPenjualanPage.modalSimpananPenjualan.PilihJenisBayarSelectComboBox().type('KREDIT{downArrow}{enter}',{force: true});
