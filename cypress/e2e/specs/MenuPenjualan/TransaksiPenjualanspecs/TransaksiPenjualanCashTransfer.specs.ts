...
import { alamat, card, jenisBayarTransfer, kodeSales, namaCustomer, noHp, noRekening, nominal, password, username } from '../../../../constant';
...
describe('AccessMenuTransaksiPenjualan', () => {
    ...
    it('click menu', () => {
        ...
        cy.wait(1000);
        page.penjualanPage.transaksiPenjualanPage.modalDataBarang.KodeBarcodeInputBox().type('00001008');
        cy.wait(5000);
