...
import { DeskripsiNominal, berat, card, deskripsiPesanan, jenisBayarDebit, jenisBayarKredit, jenisBayarTransfer, kategori, kodeSales, namaBarang, namaCustomer, noHp, noRekening, password, username } from '../../../../constant';
...
describe('TransaksiPesananTransferDebitCredit', () => {
    beforeEach(() => {
    ...
    it('click menu', () => {
        ...
        cy.wait(1000);
        page.pesananPage.transaksiPesananPage.modalDataSimpananPesanan.PilihJenisBayarSelectComboBox().type(`${jenisBayarTransfer}{downArrow}{enter}`,{force: true});
        ...
        page.pesananPage.transaksiPesananPage.modalDataSimpananPesanan.DeskripsiNominalInputBox().type(`${deskripsiPesanan}`, {force: true});
        page.pesananPage.transaksiPesananPage.modalDataSimpananPesanan.DeskripsiTambahTransaksiButtonBox().click();
        cy.wait(1000);
        page.pesananPage.transaksiPesananPage.modalDataSimpananPesanan.PilihJenisBayarSelectComboBox().type(`${jenisBayarDebit}{downArrow}{enter}`,{force: true});
        page.pesananPage.transaksiPesananPage.modalDataSimpananPesanan.NoRekeningSelectComboBox().type(`${noRekening}{downArrow}{enter}`,{force: true});
