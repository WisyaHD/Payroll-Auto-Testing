...
import { DeskripsiNominal, berat, card, deskripsiPesanan, jenisBayarTransfer, kategori, kodeSales, namaBarang, namaCustomer, noHp, noRekening, password, username } from '../../../../constant';
...
describe('TransaksiPesananCashTransfer', () => {
    beforeEach(() => {
