...
import { berat, deskripsiPesanan, jenisBayarDebit, kategori, kodeSales, namaBarang, namaCustomer, noHp, noRekening, nominal, password, username } from '../../../../constant';
...
describe('TransaksiPesananCashDebit', () => {
    ...
    it('click menu', () => {
        ...
        cy.wait(1000);
        page.pesananPage.transaksiPesananPage.modalDataSimpananPesanan.DeskripsiNominalInputBox().type(`${nominal}`, {force: true});
