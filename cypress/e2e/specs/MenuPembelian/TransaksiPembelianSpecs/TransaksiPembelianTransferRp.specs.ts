...
describe('TransaksiPembelianTransferRp', () => {
    beforeEach(() => {
    ...
    it('click menu', () => {
        ...
        cy.url().should('include', '/TransaksiPembelianTransferRp');
        cy.wait(1000);
        page.pembelianPage.transaksiPembelianPage.KodeBarcodeInputBox().type('00002268');
        cy.wait(1000);
