...
describe('Access Laporan Tambah Barang', () => {
    ...
    it('menuju laporan tambah barang lalu click cari', () => {
        ...
        sidemenu.sideMenuLaporan.laporanBarangSideMenu.selectLaporanBarangDetail(true, "-");
        cy.wait(5000);
        cy.url().should('include', '/laporan-barang-detail');
        page.laporanPage.laporanBarangPage.laporanBarangDetailPage.FilterLaporanSelectComboBox();
        cy.wait(6000);
        page.laporanPage.laporanBarangPage.laporanBarangDetailPage.exportPdfButton();
    });
